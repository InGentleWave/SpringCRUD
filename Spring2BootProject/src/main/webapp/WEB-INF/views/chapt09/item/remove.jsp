								...
								<div class="card-body">
									...
									<form action="/item/remove" method="post">
										...
										<table class="table table-bordered">
											...
											<tr>
												<td>파일</td>
												<td><img src="/item/display?itemId=${item.itemId}"
											...
											<tr>
												<td>개요</td>
												<td><textarea class="form-control" rows="5" cols="20"
										...
										<button type="button"
											onclick="javascript:location.href='/item/list'">List</button>
									</form>
								</div>
							</div>
						</div>
